        ...
        <form method="POST" role="form text-left">
            ...
            <div class="col-md-9 mb-3 mx-auto">
                <div class="form-user">
                    ...
                    <input class="form-control" type="text" placeholder="Apellidos" id="last_name" name="last_name">
                </div>
            </div>
            <div class="col-md-9 mb-3 mx-auto">
                <div class="form-user">
                    <label for="email" class="form-control-label">Correo</label>
                    <input class="form-control" type="email" placeholder="ejemplo@ejemplo.com" id="email" name="email">
                </div>
            </div>
            <div class="col-md-9 mb-3 mx-auto">
                <div class="form-user">
                    <label for="password" class="form-control-label">Contraseña</label>
                    <input class="form-control" value="" type="password" placeholder="****" id="password"
                        name="password">
                </div>
            </div>
            <div class="col-md-9 mb-3 mx-auto">
                <div class="form-user">
                    ...
                    <input class="form-control" value="" type="tel" placeholder="### ### ####" id="phone"
                        name="phone">
                </div>
            </div>
